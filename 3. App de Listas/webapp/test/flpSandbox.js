		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App de Listas",
									"targetURL": "#megaacademymod2aula2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"megaacademymod2aula2-display": {
								"semanticObject": "megaacademymod2aula2",
								"action": "display",
								"description": "App de Listas",
								"title": "App de Listas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=megaacademy.mod2aula2",
									"url": sap.ui.require.toUrl("megaacademy/mod2aula2")
								}
							}
						}
					}
